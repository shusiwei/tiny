...
export default { isTypeOf: isTypeOf, isUndefined: isUndefined, isNull: isNull, isBoolean: isBoolean, isNumber: isNumber, isFiniteNumber: isFiniteNumber, isInteger: isInteger, isSafeInteger: isSafeInteger, isPositive: isPositive, isNegative: isNegative, isPosiInteger: isPosiInteger, isNegaInteger: isNegaInteger, isFloat: isFloat, isPosiFloat: isPosiFloat, isNegaFloat: isNegaFloat, isLength: isLength, isString: isString, isFunction: isFunction, isObjectLike: isObjectLike, isObject: isObject, isPlainObject: isPlainObject, isArray: isArray, isArrayLike: isArrayLike, isRegExp: isRegExp, isDate: isDate, isError: isError, isArguments: isArguments, forEach: forEach, indexOf: indexOf, includes: includes, assign: assign, trim: trim, trimLeft: trimLeft, trimRight: trimRight, padStart: padStart, padEnd: padEnd, startsWith: startsWith, endsWith: endsWith, separate: separate, empty: empty, append: append, replace: replace, chunk: chunk, now: now, random: random, randomStamp: randomStamp };